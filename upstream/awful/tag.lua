...
function tag.move(new_index, target_tag)
    gdebug.deprecate(
        "Use t.index = new_index instead of awful.tag.move",
        { deprecated_in = 4 }
    )
...
function tag.object.swap(self, tag2)
    ...
    local scr2, scr1 =
        tag.getproperty(tag2, "screen"), tag.getproperty(self, "screen")
...
function tag.swap(tag1, tag2)
    gdebug.deprecate(
        "Use t:swap(tag2) instead of awful.tag.swap",
        { deprecated_in = 4 }
    )
...
function tag.add(name, props)
    ...
    newtag._private.awful_tag_properties =
...
function tag.new(names, screen, layout)
    ...
    local have_single_layout = not layout
        or (type(layout) == "function")
...
function tag.object.clear(self, args)
    ...
    if #clients > 0 and not args.allow_untagged then
        ...
        local fallback_tag = args.fallback_tag
            or tag.find_fallback(target_scr, { self })
...
function tag.delete(target_tag, fallback_tag)
    gdebug.deprecate(
        "Use t:delete(fallback_tag) instead of awful.tag.delete",
        { deprecated_in = 4 }
    )
...
function tag.gettags(s)
    gdebug.deprecate(
        "Use s.tags instead of awful.tag.gettags",
        { deprecated_in = 4 }
    )
...
function tag.setscreen(s, t)
    ...
    gdebug.deprecate(
        "Use t.screen = s instead of awful.tag.setscreen(t, s)",
        { deprecated_in = 4 }
    )
...
function tag.getscreen(t)
    gdebug.deprecate(
        "Use t.screen instead of awful.tag.getscreen(t)",
        { deprecated_in = 4 }
    )
...
function tag.selectedlist(s)
    gdebug.deprecate(
        "Use s.selected_tags instead of awful.tag.selectedlist",
        { deprecated_in = 4 }
    )
...
function tag.selected(s)
    gdebug.deprecate(
        "Use s.selected_tag instead of awful.tag.selected",
        { deprecated_in = 4 }
    )
...
function tag.setmwfact(mwfact, t)
    gdebug.deprecate(
        "Use t.master_width_factor = mwfact instead of awful.tag.setmwfact",
        { deprecated_in = 4 }
    )

    tag.object.set_master_width_factor(
        t or ascreen.focused().selected_tag,
        mwfact
    )
end
...
function tag.incmwfact(add, t)
    ...
    tag.object.set_master_width_factor(
        t,
        tag.object.get_master_width_factor(t) + add
    )
end
...
function tag.getmwfact(t)
    gdebug.deprecate(
        "Use t.master_width_factor instead of awful.tag.getmwfact",
        { deprecated_in = 4 }
    )

    return tag.object.get_master_width_factor(
        t or ascreen.focused().selected_tag
    )
end
...
function tag.object.set_layout(t, layout)
    ...
    then
        ...
        if
            tag.getproperty(t, "screen").selected_tag == t and instance.wake_up
        then
            instance:wake_up()
        end
...
function tag.object.get_layouts(self)
    ...
    return #cls > 0 and gtable.merge(gtable.clone(cls, false), alayout.layouts)
        or alayout.layouts
end
...
function tag.object.get_layout(t)
    ...
    return layouts and layouts[1] or require("awful.layout.suit.floating")
end
...
function tag.setlayout(layout, t)
    gdebug.deprecate(
        "Use t.layout = layout instead of awful.tag.setlayout",
        { deprecated_in = 4 }
    )
...
function tag.setvolatile(volatile, t)
    gdebug.deprecate(
        "Use t.volatile = volatile instead of awful.tag.setvolatile",
        { deprecated_in = 4 }
    )
...
function tag.getvolatile(t)
    gdebug.deprecate(
        "Use t.volatile instead of awful.tag.getvolatile",
        { deprecated_in = 4 }
    )
...
function tag.setgap(useless_gap, t)
    gdebug.deprecate(
        "Use t.gap = useless_gap instead of awful.tag.setgap",
        { deprecated_in = 4 }
    )
...
function tag.getgap(t, numclients)
    gdebug.deprecate(
        "Use t.gap instead of awful.tag.getgap",
        { deprecated_in = 4 }
    )
...
function tag.setmfpol(policy, t)
    gdebug.deprecate(
        "Use t.master_fill_policy = policy instead of awful.tag.setmfpol",
        { deprecated_in = 4 }
    )
...
function tag.getmfpol(t)
    gdebug.deprecate(
        "Use t.master_fill_policy instead of awful.tag.getmfpol",
        { deprecated_in = 4 }
    )
...
function tag.setnmaster(nmaster, t)
    gdebug.deprecate(
        "Use t.master_count = nmaster instead of awful.tag.setnmaster",
        { deprecated_in = 4 }
    )
...
function tag.getnmaster(t)
    gdebug.deprecate(
        "Use t.master_count instead of awful.tag.setnmaster",
        { deprecated_in = 4 }
    )
...
function tag.seticon(icon, _tag)
    gdebug.deprecate(
        "Use t.icon = icon instead of awful.tag.seticon",
        { deprecated_in = 4 }
    )
...
function tag.geticon(_tag)
    gdebug.deprecate(
        "Use t.icon instead of awful.tag.geticon",
        { deprecated_in = 4 }
    )
...
function tag.setncol(ncol, t)
    gdebug.deprecate(
        "Use t.column_count = new_index instead of awful.tag.setncol",
        { deprecated_in = 4 }
    )
...
function tag.getncol(t)
    gdebug.deprecate(
        "Use t.column_count instead of awful.tag.getncol",
        { deprecated_in = 4 }
    )
...
function tag.getidx(query_tag)
    gdebug.deprecate(
        "Use t.index instead of awful.tag.getidx",
        { deprecated_in = 4 }
    )
...
function tag.viewonly(t)
    gdebug.deprecate(
        "Use t:view_only() instead of awful.tag.viewonly",
        { deprecated_in = 4 }
    )
...
function tag.viewtoggle(t)
    ...
    capi.screen[tag.getproperty(t, "screen")]:emit_signal(
        "tag::history::update"
    )
end
...
function tag.withcurrent(c)
    gdebug.deprecate(
        "Use c:to_selected_tags() instead of awful.tag.selectedlist",
        { deprecated_in = 4 }
    )
