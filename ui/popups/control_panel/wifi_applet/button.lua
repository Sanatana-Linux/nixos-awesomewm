...
local function new()
    ...
    wp.on_wireless_enabled = function(_, enabled)
        if enabled then
            ...
            toggle_icon:set_image(
                gcolor.recolor_image(WIFI_ICON, applet_buttons.WHITE)
            )
            reveal_icon:set_image(
                gcolor.recolor_image(ARROW_ICON, applet_buttons.WHITE)
            )
