...
local function get_dashboard_object() return awful.screen.focused().dashboard end

-- listens for requests to toggle the dashboad in focused screen.
awesome.connect_signal('dashboard::toggle', function() get_dashboard_object().toggle() end)
