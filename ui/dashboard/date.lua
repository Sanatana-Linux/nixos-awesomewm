...
awesome.connect_signal('date::hour',
                       function(hour_val) hour.markup = hour_val end)
...
awesome.connect_signal('date::minutes',
                       function(minutes_val) minutes.markup = minutes_val end)
