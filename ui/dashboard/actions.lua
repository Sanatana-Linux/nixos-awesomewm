...
local network = make_button({
    ...
    signal = {
        ...
        callback = function(self, is_connected)
            ...
            self.bg = is_connected and beautiful.widget_back_focus
                or beautiful.widget_back
            self.fg = is_connected and beautiful.fg_normal or beautiful.fg_focus
            self.border_color = is_connected and beautiful.lessgrey
                or beautiful.grey
        end,
    },
})
...
local volume = make_button({
    ...
    signal = {
        ...
        callback = function(self, is_muted)
            ...
            self.bg = is_muted and beautiful.widget_back
                or beautiful.widget_back_focus
            self.fg = is_muted and beautiful.fg_normal or beautiful.fg_normal
            self.border_color = is_muted and beautiful.grey
                or beautiful.lessgrey
        end,
    },
})
...
local redshift = make_button({
    ...
    signal = {
        ...
        callback = function(self, is_active)
            ...
            self.bg = is_active and beautiful.widget_back_focus
                or beautiful.widget_back
            self.fg = is_active and beautiful.fg_normal or beautiful.fg_normal
            self.border_color = is_active and beautiful.lessgrey
                or beautiful.grey
        end,
    },
})
...
local airplane = make_button({
    ...
    signal = {
        ...
        callback = function(self, is_enabled)
            ...
            self.bg = is_enabled and beautiful.widget_back_focus
                or beautiful.widget_back
            self.fg = is_enabled and beautiful.fg_normal or beautiful.fg_normal
            self.border_color = is_enabled and beautiful.lessgrey
                or beautiful.grey
        end,
    },
})
