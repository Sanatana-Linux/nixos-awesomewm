...
-- -------------------------------------------------------------------------- --
local app_menu = require("ui.popups.app_menu")
-- -------------------------------------------------------------------------- --
...
local args = {
    ...
    placement = function(d)
        awful.placement.bottom_left(
            d,
            { honor_workarea = true, margins = dpi(12) }
        )
    end,
    background = beautiful.bg_normal .. "55",
    type = "dock",

    expand_apps = false,
    shape = utilities.widgets.mkroundedrect(6),
    prompt_height = 45,
    prompt_margins = 10,
    prompt_paddings = 10,
    ...
    prompt_shape = utilities.widgets.mkroundedrect(),
