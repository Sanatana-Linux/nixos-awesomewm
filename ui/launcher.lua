...
local args = {
	...
	placement = function(d) awful.placement.bottom_left(d, { honor_workarea = true, margins = dpi(12) }) end,
...
awesome.connect_signal('signal::launcher', function() app_launcher:toggle() end)
