...
screen.connect_signal("request::desktop_decoration", function(s)
  ...
  -- -------------------------------------------------------------------------- --
  --
  local launcher = utilities.interaction.mkbtn({
    image = icons.home,
    screen = s,
  ...
  local launcher_tooltip = utilities.interaction.make_popup_tooltip(
  ...
  local tray_dispatcher_tooltip = utilities.interaction.make_popup_tooltip(
  ...
  local actions_icons_container = utilities.interaction.mkbtn({
    {
      network,
      volume,
  ...
  local layoutbox = utilities.interaction.mkbtn({
    widget = wibox.container.margin,
    left = dpi(5),
    right = dpi(5),
    base_layoutbox,
  ...
  local function layoutname()
    return "Layout: " .. utilities.textual.capitalize(awful.layout.get(s).name)
  end

  -- make custom tooltip for the whole button
  local layoutbox_tooltip = utilities.interaction.make_popup_tooltip(
    layoutname(),
    function(d)
      return awful.placement.bottom_right(d, {
        margins = {
  ...
  -- layoutbox buttons
  utilities.interaction.add_buttons(layoutbox, {
