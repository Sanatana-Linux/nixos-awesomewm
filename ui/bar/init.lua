...
screen.connect_signal("request::desktop_decoration", function(s)
  ...
  local tray_dispatcher_tooltip = utilities.widgets.make_popup_tooltip("Press to toggle the systray panel", function(d)
  ...
  local layoutbox_tooltip = utilities.widgets.make_popup_tooltip(layoutname(), function(d)
    return awful.placement.bottom_right(d, {
      margins = {
        bottom = beautiful.bar_height + beautiful.useless_gap * 2,
