...
placeholder.markup = utilities.get_colorized_markup('Launch...                          ', beautiful.light_grey)
...
input:add_button(awful.button({}, 1, function() awesome.emit_signal('bar::searchbox::get_input') end))
