...
local function cross_leave(self, _)
  self:get_children_by_id("remove")[1]:set_image(gears.color.recolor_image(icons.close, beautiful.fg_normal))
end
-- -------------------------------------------------------------------------- --
local main_widget
...
local function add_notif_widget(n)
  ...
  if not drawer then
    ...
    utilities.visual.pointer_on_focus(drawer:get_children_by_id("reveal_button")[1])
    ...
    utilities.visual.pointer_on_focus(drawer:get_children_by_id("clear_button")[1])
    main_widget:insert(1, drawer)
  end
  -- -------------------------------------------------------------------------- --
