...
local mat_icons = gears.filesystem.get_configuration_dir() .. "themes/assets/icons/svg/"
...
spacing = dpi(5),
{
    ...
    shape =utilities.mkroundedrect(),
    {
        ...
        },
        {
            ...
            {
                widget = wibox.container.constraint,
                height = beautiful.get_font_height(beautiful.nerd_font .. " 13") + dpi(10),
                {
                    widget = wibox.container.margin,
                    margins = dpi(5),
                    {
...
utilities.pointer_on_focus(toggle_dnd)
utilities.pointer_on_focus(toggle_sound)
...
toggle_dnd:connect_signal("mouse::leave",function ()
    toggle_dnd.bg = beautiful.dark_grey
end)
...
toggle_sound:connect_signal("mouse::leave",function ()
    toggle_sound.bg = beautiful.dark_grey
end)
