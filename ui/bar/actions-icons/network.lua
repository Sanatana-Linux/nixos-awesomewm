...
awesome.connect_signal('network::connected', function() network.image = icons.wifi_3 end)

awesome.connect_signal('network::disconnected', function() network.image = icons.wifi_off end)
