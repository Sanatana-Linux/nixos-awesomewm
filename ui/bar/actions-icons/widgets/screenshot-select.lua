    ...
    {
      {
        genbutton({
          ...
          placement = function(d)
            return awful.placement.bottom_right(d, {
              margins = {
                bottom = (beautiful.bar_height + beautiful.useless_gap * 2) + dpi(86) + (beautiful.useless_gap * 2),
        ...
        genbutton({
          ...
          placement = function(d)
            return awful.placement.bottom_right(d, {
              margins = {
                bottom = (beautiful.bar_height + beautiful.useless_gap * 2) + dpi(60) + (beautiful.useless_gap * 2),
                right = dpi(60) + (dpi(60) / 2.75),
                top = dpi(160),
              },
            })
