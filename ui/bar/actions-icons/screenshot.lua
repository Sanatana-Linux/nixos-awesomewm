...
local function get_icon(s)
	...
	local tooltip = utilities.widgets.make_popup_tooltip("Press to take a screenshot", function(d)
	...
	awesome.connect_signal("screenshot::show", function()
		icon.image = gears.color.recolor_image(icons.camera, beautiful.bg_normal .. "66")
	end)
