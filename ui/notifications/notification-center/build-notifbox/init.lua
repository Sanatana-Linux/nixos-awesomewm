...
local empty_notifbox = require("ui.notifications.notification-center.build-notifbox.empty-notifbox")
...
local notifbox_layout = wibox.widget {
    layout = utilities.scrollbox.vertical,
    scrollbar_width = 2,
    spacing = 7,
    scroll_speed = 10
}
...
naughty.connect_signal("request::display", function(n)
    ...
    local box = require("ui.notifications.notification-center.build-notifbox.empty-notifbox")
