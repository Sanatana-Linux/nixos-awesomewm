...
local bg_normal = beautiful.bg_gradient_titlebar -- Set the normal background color
local fg_normal = beautiful.fg_alt -- Set the normal foreground color
local bg_focus = beautiful.bg_gradient_titlebar_alt -- Set the focused background color
