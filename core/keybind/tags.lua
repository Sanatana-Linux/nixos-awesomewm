...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "Left", awful.tag.viewprev, { description = "View Previous Tag", group = "Tags" }),



	-- Mod4 + Right Arrow: View next tag in sequence
	awful.key({ modkey }, "Right", awful.tag.viewnext, { description = "View Next Tag", group = "Tags" }),
