...
-- -------------------------------------------------------------------------- --
    ...
    awful.key({ modkey }, "space", function()
        capi.awesome.emit_signal("layout::changed:next")  -- Custom signal for next layout
    ...
    awful.key({ modkey, "Shift" }, "space", function()
        capi.awesome.emit_signal("layout::changed:prev")  -- Custom signal for previous layout
