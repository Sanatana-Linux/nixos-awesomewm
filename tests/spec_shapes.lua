--- Spec for `modules.shapes` factories.
...
-- we stub it via a `package.loaded` override before requiring `modules.shapes`.
...
runner.describe("shapes.rrect", function()
    runner.it("returns a closure that calls gears.shape.rounded_rect", function()
        recorded = {}
...
runner.describe("shapes.prrect", function()
    runner.it("passes per-corner radii and DPI-scaled uniform radius", function()
        recorded = {}
