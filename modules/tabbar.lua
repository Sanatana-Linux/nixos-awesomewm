...
local bg_normal = beautiful.titlebar_back  -- Set the normal background color
local fg_normal = beautiful.lesswhite  -- Set the normal foreground color
local bg_focus = beautiful.titlebar_back_focus  -- Set the focused background color
local fg_focus = beautiful.fg_focus  -- Set the focused foreground color
local bg_focus_inactive = beautiful.tabbar_bg_focus_inactive or bg_focus  -- Set the focused inactive background color
local fg_focus_inactive = beautiful.tabbar_fg_focus_inactive or fg_focus  -- Set the focused inactive foreground color
local bg_normal_inactive = beautiful.tabbar_bg_normal_inactive or bg_normal  -- Set the normal inactive background color
local fg_normal_inactive = beautiful.tabbar_fg_normal_inactive or fg_normal  -- Set the normal inactive foreground color
