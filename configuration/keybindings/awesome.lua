...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "Tab Forward Between Applications", group = "Awesome" }),
	-------------------------------------------------------------------- --
	--
	...
	awful.key({ modkey, "Shift" }, "Return", function()
		awful.spawn("rofi -show drun -config $HOME/.config/awesome/configuration/rofi/centered.rasi")
	end, { description = "Open rofi", group = "Awesome" }),
	-- -------------------------------------------------------------------------- --
	--                                  Hardware                                  --
	-- -------------------------------------------------------------------------- --
	--
