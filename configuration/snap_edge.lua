...
--                 |_____|
-- -------------------------------------------------------------------------- --
--  DESCRIPTION: enables the movement of clients like MS Windows tiling
--  mode
--  NOTE: applies to floating windows only
--  SOURCE: https://www.reddit.com/r/awesomewm/comments/kw1kr7/awesomewm_question_snap_to_leftright/
-- -------------------------------------------------------------------------- --
