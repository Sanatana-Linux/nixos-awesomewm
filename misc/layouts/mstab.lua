...
local function update_tabbar(clients, t, top_idx, area, master_area_width, slave_area_width)
	local s = t.screen
	...
	if tabbar_position == "top" then
		tabbar_x, tabbar_y, tabbar_width, tabbar_height =
			area.x + master_area_width + t.gap, area.y + t.gap, slave_area_width - 2 * t.gap, tabbar_size
	...
	elseif tabbar_position == "left" then
		tabbar_x, tabbar_y, tabbar_width, tabbar_height =
			area.x + master_area_width + t.gap, area.y + t.gap, tabbar_size, area.height - 2 * t.gap
	...
	s.tabbar.x, s.tabbar.y, s.tabbar.width, s.tabbar.height = tabbar_x, tabbar_y, tabbar_width, tabbar_height
...
function mstab.arrange(p)
	...
	local tabbar_size_change, tabbar_width_change, tabbar_y_change, tabbar_x_change = 0, 0, 0, 0
	if not tabbar_disable then
		tabbar_size_change, tabbar_y_change = tabbar_size + tabbar_padding, tabbar_size + tabbar_padding
	end
