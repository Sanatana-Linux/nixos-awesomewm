...
local units = "imperial" -- generally I prefer metric, for scientific purposes its rock solid and more rational but for temperature and determining what it feels like, imperial offers a finer grain of specificity within the average temperature ranges I personally am able to operate at. I like having the options of 48, 49, 50, 51 instead of just 9 & 10 on my indoor climate control machines, thank you very much!
local url = (
