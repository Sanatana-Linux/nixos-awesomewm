...
--- Tag (workspace) navigation and client assignment keybindings.
-- Group: "Tag".
--
-- Mod4+1..9                     switch to tag 1-9
-- Mod4+Shift+1..9               toggle focused client on tag 1-9
-- Mod4+Ctrl+Shift+1..9          toggle focused client only on tag 1-9
-- Mod4+Left / Mod4+Right        view previous / next tag in sequence
-- Mod4+Esc                      go back to previous tag (?)
-- @module configuration.keybind.tags
