...
-- Group: "Focus".
--
-- Mod4+j, Mod4+k                 next / previous client by index
-- Mod4+Tab                       restore the previously focused client
-- Mod4+Ctrl+j, Mod4+Ctrl+k       next / previous screen
-- Mod4+Ctrl+n                    restore the most recently minimized client
-- @module configuration.keybind.focus
