...
--- Layout / window management keybindings.
-- Group: "Layout".
--
-- Mod4+h / Mod4+l               decrease / increase master width
-- Mod4+Shift+h / Mod4+Shift+l   increase / decrease master client count
-- Mod4+Ctrl+h / Mod4+Ctrl+l     increase / decrease non-master columns
-- Mod4+Up / Down / Left / Right swap client by direction
-- Mod4+Ctrl+Return              set focused client as master
-- Mod4+F2                       layout navigation overlay
-- Mod4+Space / Mod4+Shift+Space next / previous layout (with 1.5s cooldown)
