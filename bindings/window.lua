...
-- Wired up under `client:connect_signal("request::default_keybindings", ...)` so
-- they only apply when the focused window is a regular client.
--
-- Group: "Window".
--
-- Mod4+f / Mod4+w               client menu / kill focused window
-- Mod4+z                         toggle floating
-- Mod4+\                         move to master
-- Mod4+o                         move to other screen
-- Mod4+t                         toggle always-on-top
-- Mod4+n / Mod4+m                minimize / un-maximize
-- Mod4+Ctrl+m / Mod4+Shift+m    toggle vertical / horizontal maximize
-- Mod4+Ctrl+arrow keys          resize floating client
-- Mod4+Shift+arrow keys         move floating client
-- Mod4+Shift+numpad-keys        snap window to corner / edge of screen
