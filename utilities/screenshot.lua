...
local function random_id() return os.tmpname():gsub('/tmp/lua_', '') end
-- -------------------------------------------------------------------------- --
-- returns an unique path for the screenshot inside the 'Pictures' folder.
local function get_path() return os.getenv('HOME') .. '/Pictures/screenshot-' .. random_id() .. '.png' end
-- -------------------------------------------------------------------------- --
...
function M.with_options(opts)
	...
	--
	if opts.timeout <= 0 then return core() end
	-------------------------------------------------------------------------- --
